...
- (void)viewDidLoad
{
    ...
    self.player.clientId = @"you key";
    self.player.clientSecret = @"you key";
...
- (void)initViews
{
    ...
    _nextButton.frame = CGRectMake(MARGIN, self.view.bounds.size.width * 9.0f / 16.0f , self.view.bounds.size.width, 40);
    [_nextButton addTarget:self action:@selector(openNextView) forControlEvents:UIControlEventTouchUpInside];
